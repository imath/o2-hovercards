		...
		makepot: {
			target: {
				options: {
					...
					mainFile: 'o2-hovercards.php',
					potFilename: 'o2-hovercards.pot',
					processPot: function( pot ) {
						pot.headers['last-translator']      = 'imath <contact@imathi.eu>';
						pot.headers['language-team']        = 'FRENCH <contact@imathi.eu>';
						pot.headers['report-msgid-bugs-to'] = 'https://github.com/imath/o2-hovercards/issues';
						return pot;
					},
					type: 'wp-plugin'
				}
